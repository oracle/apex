# Fusion Apps REST Source Catalog 25D Reference
...
```sql
@/scratch/rest-source-catalogs/fusion/25d/fa-hcm-rest-catalog-25d.sql
```
...
5. Drag and drop the Catalog sql file, for example, '/scratch/rest-source-catalogs/fusion/25d/fa-hcm-rest-catalog-25d.sql'
