...
/
prompt --workspace/rest-source-catalogs/25C_common
begin
wwv_web_src_catalog_api.create_catalog(
 p_id=>wwv_flow_imp.id(23506147284689481)
,p_name=>'common (Release 25C)'
,p_internal_name=>'25C_COMMON'
,p_format=>'APEX'
);
end;
/
...
wwv_web_src_catalog_api.create_catalog_service(
 p_id=>wwv_flow_imp.id(23506239389689484)
,p_catalog_id=>wwv_flow_imp.id(23506147284689481)
...
begin
wwv_web_src_catalog_api.create_catalog_service(
 p_id=>wwv_flow_imp.id(23506335143689484)
,p_catalog_id=>wwv_flow_imp.id(23506147284689481)
...
begin
wwv_web_src_catalog_api.create_catalog_service(
 p_id=>wwv_flow_imp.id(23506435383689485)
,p_catalog_id=>wwv_flow_imp.id(23506147284689481)
,p_name=>q'{ATK Themes}'
...
begin
wwv_web_src_catalog_api.create_catalog_service(
 p_id=>wwv_flow_imp.id(23506539243689486)
,p_catalog_id=>wwv_flow_imp.id(23506147284689481)
,p_name=>q'{Persons}'
