# Fusion Apps REST Source Catalog 25C Reference
...
```sql
@/scratch/rest-source-catalogs/fusion/25c/fa-hcm-rest-catalog-25c.sql
```
...
5. Drag and drop the Catalog sql file, for example, '/scratch/rest-source-catalogs/fusion/25c/fa-hcm-rest-catalog-25c.sql'
