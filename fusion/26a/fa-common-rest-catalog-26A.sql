...
/
prompt --workspace/rest-source-catalogs/26A_common
begin
wwv_web_src_catalog_api.create_catalog(
 p_id=>wwv_flow_imp.id(23646302908723646)
,p_name=>'common (Release 26A)'
,p_internal_name=>'26A_COMMON'
,p_format=>'APEX'
);
end;
/
...
wwv_web_src_catalog_api.create_catalog_service(
 p_id=>wwv_flow_imp.id(23646486559723647)
,p_catalog_id=>wwv_flow_imp.id(23646302908723646)
...
begin
wwv_web_src_catalog_api.create_catalog_service(
 p_id=>wwv_flow_imp.id(23646555348723648)
,p_catalog_id=>wwv_flow_imp.id(23646302908723646)
...
begin
wwv_web_src_catalog_api.create_catalog_service(
 p_id=>wwv_flow_imp.id(23646621566723649)
,p_catalog_id=>wwv_flow_imp.id(23646302908723646)
,p_name=>q'{ATK Themes}'
...
begin
wwv_web_src_catalog_api.create_catalog_service(
 p_id=>wwv_flow_imp.id(23646795323723649)
,p_catalog_id=>wwv_flow_imp.id(23646302908723646)
,p_name=>q'{Persons}'
