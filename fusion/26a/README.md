...
```sql
@/scratch/rest-source-catalogs/fusion/26a/fa-hcm-rest-catalog-26a.sql
```
...
5. Drag and drop the Catalog sql file, for example, '/scratch/rest-source-catalogs/fusion/26a/fa-hcm-rest-catalog-26a.sql'
