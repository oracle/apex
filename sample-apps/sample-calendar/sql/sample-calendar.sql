...
,p_apexlang_name=>'parentElementColumn'
...
,p_apexlang_name=>'childElementColumn'
,p_attribute_type=>'REGION SOURCE COLUMN'
,p_is_required=>true
,p_column_data_types=>'VARCHAR2'
,p_is_translatable=>false
...
,p_apexlang_name=>'childElementAltNameColumn'
,p_attribute_type=>'REGION SOURCE COLUMN'
,p_is_required=>false
,p_column_data_types=>'VARCHAR2'
,p_is_translatable=>false
...
,p_apexlang_name=>'childElementStyleColumn'
,p_attribute_type=>'REGION SOURCE COLUMN'
,p_is_required=>false
,p_column_data_types=>'VARCHAR2'
,p_is_translatable=>false
...
,p_apexlang_name=>'childElementStartColumn'
,p_attribute_type=>'REGION SOURCE COLUMN'
,p_is_required=>true
...
,p_apexlang_name=>'childElementEndColumn'
,p_attribute_type=>'REGION SOURCE COLUMN'
,p_is_required=>true
,p_column_data_types=>'DATE:TIMESTAMP:TIMESTAMP_TZ:TIMESTAMP_LTZ'
,p_is_translatable=>false
...
,p_apexlang_name=>'parentElementLink'
...
,p_apexlang_name=>'childElementLink'
,p_attribute_type=>'LINK'
,p_is_required=>false
,p_is_translatable=>false
,p_reference_scope=>'ROW'
...
,p_apexlang_name=>'periodTypePageItem'
...
,p_apexlang_name=>'startDatePageItem'
,p_attribute_type=>'TEXT'
,p_is_required=>false
,p_is_translatable=>false
...
,p_apexlang_name=>'periodsPerType'
,p_attribute_type=>'TEXT'
,p_is_required=>true
...
,p_apexlang_name=>'timelineAndStatusList'
...
,p_apexlang_name=>'primaryDescription'
,p_attribute_type=>'REGION SOURCE COLUMN'
,p_is_required=>false
,p_column_data_types=>'VARCHAR2'
,p_is_translatable=>false
...
,p_apexlang_name=>'secondaryDescription'
,p_attribute_type=>'REGION SOURCE COLUMN'
,p_is_required=>false
,p_is_common=>false
,p_column_data_types=>'VARCHAR2'
...
,p_apexlang_name=>'additionalDescriptionWithHtml'
,p_attribute_type=>'REGION SOURCE COLUMN'
,p_is_required=>false
,p_is_common=>false
,p_column_data_types=>'VARCHAR2'
...
,p_apexlang_name=>'secondAdditionalDescriptionWithHtml'
,p_attribute_type=>'REGION SOURCE COLUMN'
,p_is_required=>false
,p_is_common=>false
,p_column_data_types=>'VARCHAR2'
...
,p_static_id=>'calendar-with-report'
...
,p_static_id=>'calendar-and-dynamic-actions'
,p_list_item_link_target=>'f?p=&APP_ID.:50:&SESSION.::&DEBUG.::::'
,p_list_item_icon=>'fa-calendar-check-o'
,p_list_item_current_type=>'TARGET_PAGE'
);
...
,p_static_id=>'calendar-and-javascript'
,p_list_item_link_target=>'f?p=&APP_ID.:70:&SESSION.::&DEBUG.::::'
,p_list_item_icon=>'fa-code'
,p_list_item_current_type=>'TARGET_PAGE'
);
...
,p_static_id=>'custom-drag-drop-handlers'
,p_list_item_link_target=>'f?p=&APP_ID.:112:&SESSION.::&DEBUG.::::'
,p_parent_list_item_id=>wwv_flow_imp.id(788180364295598678)
,p_list_item_current_type=>'COLON_DELIMITED_PAGE_LIST'
...
,p_static_id=>'valid-status-codes'
...
,p_static_id=>'end-date-later-than-start-date'
...
,p_static_id=>'fetch-row-from-eba-demo-cal-projects'
,p_attributes=>wwv_flow_t_plugin_attributes(wwv_flow_t_varchar2(
  'primary_key_column', 'ID',
  'primary_key_item', 'P3_ID',
  'table_name', 'EBA_DEMO_CAL_PROJECTS')).to_clob
...
,p_static_id=>'process-row-of-eba-demo-cal-projects'
,p_attributes=>wwv_flow_t_plugin_attributes(wwv_flow_t_varchar2(
  'lock_row', 'Y',
  'primary_key_column', 'ID',
  'primary_key_item', 'P3_ID',
  'return_key_into_item', 'P3_ID',
  'supported_operations', 'I:U',
  'table_name', 'EBA_DEMO_CAL_PROJECTS')).to_clob
,p_error_display_location=>'INLINE_IN_NOTIFICATION'
...
,p_static_id=>'change-project-refresh-calendar'
,p_event_sequence=>10
,p_triggering_element_type=>'ITEM'
...
,p_static_id=>'change-show-inactive-sessions'
,p_event_sequence=>20
,p_triggering_element_type=>'ITEM'
...
,p_static_id=>'dialog-closed-refresh-calendar'
,p_event_sequence=>10
,p_triggering_element_type=>'REGION'
...
,p_static_id=>'calendar-view-changed-refresh-report'
,p_event_sequence=>20
,p_triggering_element_type=>'REGION'
...
,p_attributes=>wwv_flow_t_plugin_attributes(wwv_flow_t_varchar2(
  'js_expression', 'this.data.startDate',
  'suppress_change_event', 'N',
  'type', 'JAVASCRIPT_EXPRESSION')).to_clob
,p_wait_for_result=>'Y'
);
...
,p_attributes=>wwv_flow_t_plugin_attributes(wwv_flow_t_varchar2(
  'js_expression', 'this.data.endDate',
  'suppress_change_event', 'N',
  'type', 'JAVASCRIPT_EXPRESSION')).to_clob
,p_wait_for_result=>'Y'
);
...
,p_static_id=>'page-load-restrict-report-to-current-month'
,p_event_sequence=>30
,p_bind_type=>'bind'
,p_execution_type=>'IMMEDIATE'
...
,p_affected_elements=>'P51_CAL_START_DATE'
,p_attributes=>wwv_flow_t_plugin_attributes(wwv_flow_t_varchar2(
  'js_expression', 'formatYYYYMMDDhhmmss( apex.region("tasks_cal").widget().data("fullCalendar").view.activeStart )',
...
,p_affected_elements=>'P51_CAL_END_DATE'
,p_attributes=>wwv_flow_t_plugin_attributes(wwv_flow_t_varchar2(
  'js_expression', 'formatYYYYMMDDhhmmss( apex.region("tasks_cal").widget().data("fullCalendar").view.activeEnd )',
  'suppress_change_event', 'Y',
  'type', 'JAVASCRIPT_EXPRESSION')).to_clob
,p_wait_for_result=>'Y'
);
...
,p_static_id=>'date-range-selected-create-new-event'
,p_event_sequence=>30
,p_triggering_element_type=>'REGION'
...
,p_attributes=>wwv_flow_t_plugin_attributes(wwv_flow_t_varchar2(
  'items_to_submit', 'P52_STARTDATE,P52_ENDDATE',
  'language', 'PLSQL',
...
,p_attributes=>wwv_flow_t_plugin_attributes(wwv_flow_t_varchar2(
  'js_expression', 'this.data.newStartDate',
  'suppress_change_event', 'Y',
  'type', 'JAVASCRIPT_EXPRESSION')).to_clob
,p_wait_for_result=>'Y'
);
...
,p_attributes=>wwv_flow_t_plugin_attributes(wwv_flow_t_varchar2(
  'js_expression', 'this.data.newEndDate',
  'suppress_change_event', 'N',
  'type', 'JAVASCRIPT_EXPRESSION')).to_clob
,p_wait_for_result=>'Y'
);
...
,p_static_id=>'event-clicked-confirm-and-delete'
,p_event_sequence=>30
,p_triggering_element_type=>'REGION'
...
,p_attributes=>wwv_flow_t_plugin_attributes(wwv_flow_t_varchar2(
  'message', 'Do you really want to delete that event?')).to_clob
);
wwv_flow_imp_page.create_page_da_action(
...
,p_action=>'NATIVE_EXECUTE_PLSQL_CODE'
,p_attributes=>wwv_flow_t_plugin_attributes(wwv_flow_t_varchar2(
  'items_to_submit', 'P53_SESSION_ID',
  'language', 'PLSQL',
  'plsql_code', wwv_flow_string.join(wwv_flow_t_varchar2(
    'begin',
...
,p_attributes=>wwv_flow_t_plugin_attributes(wwv_flow_t_varchar2(
  'js_expression', 'this.data.event.id',
  'suppress_change_event', 'Y',
  'type', 'JAVASCRIPT_EXPRESSION')).to_clob
,p_wait_for_result=>'Y'
);
...
,p_action=>'NATIVE_EXECUTE_PLSQL_CODE'
,p_attributes=>wwv_flow_t_plugin_attributes(wwv_flow_t_varchar2(
  'items_to_submit', 'P54_SESSION_ID',
  'language', 'PLSQL',
  'plsql_code', wwv_flow_string.join(wwv_flow_t_varchar2(
    'begin',
...
,p_static_id=>'calendar-next-month'
,p_event_sequence=>20
,p_triggering_element_type=>'BUTTON'
...
,p_attributes=>wwv_flow_t_plugin_attributes(wwv_flow_t_varchar2(
  'js_code', 'apex.region("project_tasks").widget().data("fullCalendar").next()')).to_clob
);
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(788243921149877994)
,p_name=>'Calendar: Prev Month'
,p_static_id=>'calendar-prev-month'
,p_event_sequence=>30
,p_triggering_element_type=>'BUTTON'
...
,p_action=>'NATIVE_JAVASCRIPT_CODE'
,p_attributes=>wwv_flow_t_plugin_attributes(wwv_flow_t_varchar2(
  'js_code', 'apex.region("project_tasks").widget().data("fullCalendar").prev()')).to_clob
);
wwv_flow_imp_page.create_page_da_event(
...
,p_action=>'NATIVE_JAVASCRIPT_CODE'
,p_attributes=>wwv_flow_t_plugin_attributes(wwv_flow_t_varchar2(
  'js_code', 'apex.region("project_tasks").widget().data("fullCalendar").changeView($v("P71_VIEWTYPE"))')).to_clob
);
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(788244148354877997)
,p_name=>'Focus Date'
,p_static_id=>'focus-date'
,p_event_sequence=>40
,p_triggering_element_type=>'ITEM'
...
,p_attributes=>wwv_flow_t_plugin_attributes(wwv_flow_t_varchar2(
  'message', 'Please use YYYY-MM-DD')).to_clob
);
wwv_flow_imp_page.create_page_da_action(
...
,p_action=>'NATIVE_JAVASCRIPT_CODE'
,p_attributes=>wwv_flow_t_plugin_attributes(wwv_flow_t_varchar2(
  'js_code', 'apex.region("project_tasks").widget().data("fullCalendar").gotoDate($v("P71_GOTODATE"))')).to_clob
);
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(788247720707878032)
,p_name=>'Set Goto Date to "today"'
,p_static_id=>'set-goto-date-to-today'
,p_event_sequence=>70
,p_triggering_element_type=>'BUTTON'
...
,p_attributes=>wwv_flow_t_plugin_attributes(wwv_flow_t_varchar2(
  'js_expression', 'apex.region("project_tasks").widget().data("fullCalendar").view.type',
  'suppress_change_event', 'Y',
  'type', 'JAVASCRIPT_EXPRESSION')).to_clob
,p_wait_for_result=>'Y'
);
...
,p_static_id=>'get-calendar-status'
,p_event_sequence=>30
,p_triggering_element_type=>'REGION'
...
,p_attributes=>wwv_flow_t_plugin_attributes(wwv_flow_t_varchar2(
  'js_expression', 'this.data.viewType',
  'suppress_change_event', 'Y',
  'type', 'JAVASCRIPT_EXPRESSION')).to_clob
,p_wait_for_result=>'Y'
);
...
,p_attributes=>wwv_flow_t_plugin_attributes(wwv_flow_t_varchar2(
  'js_expression', 'this.data.dates.startDate.toDateString()',
  'suppress_change_event', 'Y',
  'type', 'JAVASCRIPT_EXPRESSION')).to_clob
,p_wait_for_result=>'Y'
);
...
,p_attributes=>wwv_flow_t_plugin_attributes(wwv_flow_t_varchar2(
  'js_expression', 'this.data.dates.endDate.toDateString()',
  'suppress_change_event', 'Y',
  'type', 'JAVASCRIPT_EXPRESSION')).to_clob
,p_wait_for_result=>'Y'
);
...
,p_static_id=>'create-javascript-event'
,p_event_sequence=>40
,p_triggering_element_type=>'BUTTON'
...
,p_attributes=>wwv_flow_t_plugin_attributes(wwv_flow_t_varchar2(
  'js_code', wwv_flow_string.join(wwv_flow_t_varchar2(
    ...
    '    ;',
    '',
    'apex.event.trigger(this.affectedElements, "click");')))).to_clob
);
wwv_flow_imp_page.create_page_da_action(
...
,p_attributes=>wwv_flow_t_plugin_attributes(wwv_flow_t_varchar2(
  'js_expression', 'formatYYYYMMDDhhmmss( this.data.dates.newStartDate )',
  'suppress_change_event', 'Y',
  'type', 'JAVASCRIPT_EXPRESSION')).to_clob
,p_wait_for_result=>'Y'
);
...
,p_attributes=>wwv_flow_t_plugin_attributes(wwv_flow_t_varchar2(
  'js_expression', 'formatYYYYMMDDhhmmss( this.data.dates.newEndDate )',
  'suppress_change_event', 'N',
  'type', 'JAVASCRIPT_EXPRESSION')).to_clob
,p_wait_for_result=>'Y'
);
...
,p_static_id=>'event-data-changed-show-in-calendar'
,p_event_sequence=>60
,p_triggering_element_type=>'ITEM'
...
,p_affected_button_id=>wwv_flow_imp.id(788246440974878020)
,p_attributes=>wwv_flow_t_plugin_attributes(wwv_flow_t_varchar2(
  'js_code', 'apex.event.trigger(this.affectedElements, "click");')).to_clob
);
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(788247044326878026)
,p_name=>'Save Event to Database'
,p_static_id=>'save-event-to-database'
,p_event_sequence=>50
,p_triggering_element_type=>'BUTTON'
...
,p_action=>'NATIVE_EXECUTE_PLSQL_CODE'
,p_attributes=>wwv_flow_t_plugin_attributes(wwv_flow_t_varchar2(
  'items_to_submit', 'P73_TITLE,P73_SESSION_TYPE,P73_STARTDATE,P73_ENDDATE',
  'language', 'PLSQL',
  'plsql_code', wwv_flow_string.join(wwv_flow_t_varchar2(
    'begin',
    '    insert into eba_demo_cal_sessions (title, speaker, session_type, status, start_date, end_date)',
...
,p_action=>'NATIVE_CONFIRM'
,p_attributes=>wwv_flow_t_plugin_attributes(wwv_flow_t_varchar2(
  'message', 'Clear your schedule: Really?')).to_clob
);
wwv_flow_imp_page.create_page_da_action(
...
,p_attributes=>wwv_flow_t_plugin_attributes(wwv_flow_t_varchar2(
  'language', 'PLSQL',
  'plsql_code', 'delete from eba_demo_cal_mysessions;',
  'show_processing', 'N')).to_clob
,p_wait_for_result=>'Y'
);
wwv_flow_imp_page.create_page_da_action(
...
,p_action=>'NATIVE_JAVASCRIPT_CODE'
,p_attributes=>wwv_flow_t_plugin_attributes(wwv_flow_t_varchar2(
  'js_code', 'apex.message.showPageSuccess("Schedule cleared.")')).to_clob
);
wwv_flow_imp_page.create_page_da_action(
...
,p_static_id=>'date-range-selected'
,p_event_sequence=>90
,p_triggering_element_type=>'REGION'
...
,p_static_id=>'delete-selected-event'
,p_event_sequence=>80
,p_triggering_element_type=>'REGION'
,p_triggering_region_id=>wwv_flow_imp.id(792090068321540613)
,p_triggering_condition_type=>'JAVASCRIPT_EXPRESSION'
...
,p_action=>'NATIVE_EXECUTE_PLSQL_CODE'
,p_attributes=>wwv_flow_t_plugin_attributes(wwv_flow_t_varchar2(
  'items_to_submit', 'P74_MY_SESSION_ID',
  'language', 'PLSQL',
  'plsql_code', wwv_flow_string.join(wwv_flow_t_varchar2(
    'begin',
...
,p_action=>'NATIVE_JAVASCRIPT_CODE'
,p_attributes=>wwv_flow_t_plugin_attributes(wwv_flow_t_varchar2(
  'js_code', 'apex.message.showPageSuccess("\u0022" + this.data.event.title + "\u0022 removed.")')).to_clob
);
wwv_flow_imp_page.create_page_da_action(
...
,p_static_id=>'event-selected-copy-to-my-sessions'
,p_event_sequence=>70
,p_triggering_element_type=>'REGION'
...
,p_action=>'NATIVE_JAVASCRIPT_CODE'
,p_attributes=>wwv_flow_t_plugin_attributes(wwv_flow_t_varchar2(
  'js_code', 'apex.message.showPageSuccess("\u0022" + this.data.event.title + "\u0022 added.")')).to_clob
);
wwv_flow_imp_page.create_page_da_action(
...
,p_action=>'NATIVE_EXECUTE_PLSQL_CODE'
,p_attributes=>wwv_flow_t_plugin_attributes(wwv_flow_t_varchar2(
  'items_to_submit', 'P74_TITLE,P74_STARTDATE,P74_ENDDATE',
  'language', 'PLSQL',
  'plsql_code', wwv_flow_string.join(wwv_flow_t_varchar2(
    'begin',
...
,p_action=>'NATIVE_JAVASCRIPT_CODE'
,p_attributes=>wwv_flow_t_plugin_attributes(wwv_flow_t_varchar2(
  'js_code', 'apex.message.showPageSuccess("\u0022" + $v("P74_TITLE") + "\u0022 added.")')).to_clob
);
wwv_flow_imp_page.create_page_da_action(
...
,p_static_id=>'search-changed-refresh'
...
,p_static_id=>'set-calendar-aspectratio'
...
,p_attributes=>wwv_flow_t_plugin_attributes(wwv_flow_t_varchar2(
  'js_code', wwv_flow_string.join(wwv_flow_t_varchar2(
    ...
    'apex.region("my_session_calendar").widget().data("fullCalendar").setOption("aspectRatio", 1.3);')))).to_clob
);
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(2101885676760027793)
,p_name=>'Sync "Conf Session" Scroll with "My Session" Scroll'
,p_static_id=>'sync-conf-session-scroll-with-my-session-scroll'
...
,p_action=>'NATIVE_JAVASCRIPT_CODE'
,p_attributes=>wwv_flow_t_plugin_attributes(wwv_flow_t_varchar2(
  'js_code', '$("#session_calendar .fc-scroller").scrollTop($("#my_session_calendar .fc-scroller").scrollTop());')).to_clob
);
end;
/
...
,p_action=>'NATIVE_JAVASCRIPT_CODE'
,p_attributes=>wwv_flow_t_plugin_attributes(wwv_flow_t_varchar2(
  'js_code', 'apex.message.showPageSuccess( $v( "P112_DRAGDROP_MSG") );')).to_clob
);
wwv_flow_imp_page.create_page_da_action(
...
,p_attributes=>wwv_flow_t_plugin_attributes(wwv_flow_t_varchar2(
  ...
  'plsql_expression', 'v( ''P112_DRAGDROP_MSG'' ) ',
  'suppress_change_event', 'N',
...
,p_static_id=>'change-session-type'
,p_event_sequence=>20
,p_triggering_element_type=>'ITEM'
...
,p_static_id=>'fetch-row-from-eba-demo-cal-sessions'
,p_attributes=>wwv_flow_t_plugin_attributes(wwv_flow_t_varchar2(
  'primary_key_column', 'ID',
  'primary_key_item', 'P301_ID',
  'table_name', 'EBA_DEMO_CAL_SESSIONS')).to_clob
...
,p_static_id=>'process-row-of-eba-demo-cal-sessions'
,p_attributes=>wwv_flow_t_plugin_attributes(wwv_flow_t_varchar2(
  'lock_row', 'Y',
  'primary_key_column', 'ID',
  'primary_key_item', 'P301_ID',
...
begin
wwv_flow_imp.g_varchar2_table := wwv_flow_imp.empty_varchar2_table;
wwv_flow_imp.g_varchar2_table(1) := 'DROP TABLE  "EBA_DEMO_CAL_PROJECTS" cascade constraints;'||wwv_flow.LF||
''||wwv_flow.LF||
'drop table "EBA_DEMO_CAL_SESSIONS" cascade';
wwv_flow_imp.g_varchar2_table(2) := ' constraints;'||wwv_flow.LF||
''||wwv_flow.LF||
'drop table "EBA_DEMO_CAL_MYSESSIONS" cascade constraints;'||wwv_flow.LF||
''||wwv_flow.LF||
''||wwv_flow.LF||
'drop procedure EBA_DEMO_C';
wwv_flow_imp.g_varchar2_table(3) := 'AL_DATA;'||wwv_flow.LF||
'';
