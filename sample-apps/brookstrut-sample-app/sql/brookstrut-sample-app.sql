...
,p_application_group_static_id=>'sample-applications'
...
,p_apexlang_name=>'copyOfContentRow'
...
,p_apexlang_name=>'imageDescription'
...
,p_static_id=>'products-available-by-store'
...
,p_static_id=>'reset-sample-data-list'
,p_version_scn=>'37167692709710'
);
wwv_flow_imp_shared.create_list_item(
...
,p_static_id=>'api-calls-per-hour'
...
,p_static_id=>'api-calls-per-minute'
...
,p_static_id=>'oow-demo-stores-store-name'
,p_source_type=>'TABLE'
,p_location=>'LOCAL'
...
,p_static_id=>'sales-history-navigation'
...
,p_static_id=>'faceted-classic-report'
);
wwv_flow_imp_shared.create_static_lov_data(
...
,p_static_id=>'faceted-content-row'
);
wwv_flow_imp_shared.create_static_lov_data(
...
,p_static_id=>'faceted-content-row-with-menus'
);
wwv_flow_imp_shared.create_static_lov_data(
...
,p_static_id=>'smart-search-content-row-with-menu'
);
wwv_flow_imp_shared.create_static_lov_data(
...
,p_static_id=>'smart-search-with-classic-cards'
);
end;
/
...
,p_static_id=>'truncation-options'
...
,p_static_id=>'retain-existing-history-and-generate-additional-history'
);
wwv_flow_imp_shared.create_static_lov_data(
...
,p_static_id=>'truncate-existing-sales-history-and-generate-new-history'
);
end;
/
...
,p_static_id=>'redwood-light-dark-header'
...
,p_static_id=>'on-navigation-click'
,p_event_sequence=>10
...
,p_attributes=>wwv_flow_t_plugin_attributes(wwv_flow_t_varchar2(
  ...
  'items_to_submit', 'P3_ADD_ID',
  'sql_query', 'select msrp from OOW_DEMO_items where id = :P3_ADD_ID;',
...
,p_static_id=>'gen-xaction-refresh-content'
,p_event_sequence=>10
...
,p_static_id=>'p7-store-address-not-null'
...
,p_static_id=>'p7-store-city-not-null'
...
,p_static_id=>'p7-store-name-not-null'
...
,p_static_id=>'fetch-row-from-oow-demo-stores'
,p_attributes=>wwv_flow_t_plugin_attributes(wwv_flow_t_varchar2(
...
,p_static_id=>'process-row-of-oow-demo-stores'
,p_attributes=>wwv_flow_t_plugin_attributes(wwv_flow_t_varchar2(
  'lock_row', 'Y',
  'primary_key_column', 'ID',
  'primary_key_item', 'P7_ID',
  'return_key_into_item', 'P7_ID',
...
,p_static_id=>'fetch-row-from-oow-demo-regions'
,p_attributes=>wwv_flow_t_plugin_attributes(wwv_flow_t_varchar2(
  'primary_key_column', 'ID',
  'primary_key_item', 'P9_ID',
  'table_name', 'OOW_DEMO_REGIONS')).to_clob
...
,p_static_id=>'process-row-of-oow-demo-regions'
,p_attributes=>wwv_flow_t_plugin_attributes(wwv_flow_t_varchar2(
  'lock_row', 'Y',
  'primary_key_column', 'ID',
  'primary_key_item', 'P9_ID',
...
,p_static_id=>'p12-item-name-not-null'
,p_validation_sequence=>10
...
,p_static_id=>'fetch-row-from-oow-demo-items'
,p_attributes=>wwv_flow_t_plugin_attributes(wwv_flow_t_varchar2(
  'primary_key_column', 'ID',
  'primary_key_item', 'P12_ID',
  'table_name', 'OOW_DEMO_ITEMS')).to_clob
...
,p_static_id=>'process-row-of-oow-demo-items'
,p_attributes=>wwv_flow_t_plugin_attributes(wwv_flow_t_varchar2(
  'lock_row', 'Y',
  'primary_key_column', 'ID',
  'primary_key_item', 'P12_ID',
...
,p_static_id=>'on-report-view-change'
,p_event_sequence=>10
,p_triggering_element_type=>'ITEM'
...
,p_static_id=>'refresh-report-on-change'
,p_event_sequence=>10
,p_triggering_element_type=>'ITEM'
...
,p_static_id=>'clear-cache-for-transaction-page'
,p_attributes=>wwv_flow_t_plugin_attributes(wwv_flow_t_varchar2(
  'pages', '30',
...
,p_attributes=>wwv_flow_t_plugin_attributes(wwv_flow_t_varchar2(
  'language', 'PLSQL',
  'plsql_code', ':P29_TRANSACTION_ID := oow_demo_gen_data_pkg.generate_transaction;',
  'show_processing', 'N')).to_clob
,p_wait_for_result=>'Y'
);
wwv_flow_imp_page.create_page_da_action(
...
,p_static_id=>'show-last-generation'
...
,p_action=>'NATIVE_EXECUTE_PLSQL_CODE'
,p_attributes=>wwv_flow_t_plugin_attributes(wwv_flow_t_varchar2(
  'items_to_submit', 'P30_AUTOREFRESH',
  'language', 'PLSQL',
  'plsql_code', 'null;',
  'show_processing', 'N')).to_clob
,p_wait_for_result=>'Y'
...
,p_attributes=>wwv_flow_t_plugin_attributes(wwv_flow_t_varchar2(
  'js_code', 'setTimeout("location.reload(true);",1000 * $v(''P30_AUTOREFRESH''));')).to_clob
);
end;
/
...
,p_static_id=>'p36-transaction-date'
...
,p_static_id=>'p36-transaction-id'
,p_computation_point=>'AFTER_HEADER'
,p_computation_type=>'QUERY'
,p_computation=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
begin
wwv_flow_imp.g_varchar2_table := wwv_flow_imp.empty_varchar2_table;
wwv_flow_imp.g_varchar2_table(1) := 'create index OOW_DEMO_STORE_PRODUCTS_i1 on OOW_DEMO_STORE_PRODUCTS (store_id);'||wwv_flow.LF||
'create index OOW_DEMO';
wwv_flow_imp.g_varchar2_table(2) := '_STORE_PRODUCTS_i2 on OOW_DEMO_STORE_PRODUCTS (item_id);'||wwv_flow.LF||
'create index oow_demo_sales_history_i1 on o';
wwv_flow_imp.g_varchar2_table(3) := 'ow_demo_sales_history (store_id);'||wwv_flow.LF||
'create index oow_demo_sales_history_i2 on oow_demo_sales_history (';
wwv_flow_imp.g_varchar2_table(4) := 'product_id);'||wwv_flow.LF||
'    ';
wwv_flow_imp_shared.create_install_script(
...
begin
wwv_flow_imp.g_varchar2_table := wwv_flow_imp.empty_varchar2_table;
wwv_flow_imp.g_varchar2_table(1) := 'rem ALTER SESSION SET PLSCOPE_SETTINGS = ''IDENTIFIERS:NONE'';';
wwv_flow_imp_shared.create_install_script(
...
begin
wwv_flow_imp.g_varchar2_table := wwv_flow_imp.empty_varchar2_table;
wwv_flow_imp.g_varchar2_table(1) := 'create sequence oow_demo_seq;';
wwv_flow_imp_shared.create_install_script(
