...
,p_static_id=>'drill-down-interactive-grid'
...
,p_static_id=>'drill-down-interactive-report'
...
,p_static_id=>'reporting-from-collections'
...
,p_static_id=>'resetting-pagination'
...
,p_static_id=>'sql-analytic-examples'
,p_version_scn=>'1089078416'
);
wwv_flow_imp_shared.create_list_item(
...
,p_static_id=>'distinct-status-values'
...
,p_static_id=>'number-of-rows-per-page'
...
,p_static_id=>'sample-reporting-active-filters'
...
,p_static_id=>'sample-reports-comment-bubbles'
...
,p_static_id=>'fetch-row-from-eba-demo-ir-projects'
,p_attributes=>wwv_flow_t_plugin_attributes(wwv_flow_t_varchar2(
  'primary_key_column', 'ROWID',
  'primary_key_item', 'P2_ROWID',
  'table_name', 'EBA_DEMO_IR_PROJECTS')).to_clob
...
,p_static_id=>'process-row-of-eba-demo-ir-projects'
,p_attributes=>wwv_flow_t_plugin_attributes(wwv_flow_t_varchar2(
  'lock_row', 'Y',
  'primary_key_column', 'ROWID',
  'primary_key_item', 'P2_ROWID',
...
,p_static_id=>'submit-report-on-status-filter-change'
,p_event_sequence=>10
,p_triggering_element_type=>'ITEM'
...
,p_static_id=>'format-mask-example-report'
...
,p_static_id=>'drill-down-donut-chart-based-on-user-s-interactive-report-filters'
...
,p_static_id=>'get-chart-data-from-ir-result'
,p_event_sequence=>10
,p_triggering_element_type=>'REGION'
...
,p_static_id=>'projects-save-interactive-grid-data'
,p_attributes=>wwv_flow_t_plugin_attributes(wwv_flow_t_varchar2(
  'lock_row', 'Y',
...
,p_static_id=>'query-use-regex-functions'
...
,p_static_id=>'listagg-query-syntax'
,p_region_name=>'QUERY'
...
,p_static_id=>'interactive-report-on-collection'
...
wwv_flow_imp.g_varchar2_table(15) := 'ation scheme(s)'',to_date(''01/01/2016'',''MM/DD/YYYY''),to_date(''01/01/2016'',''MM/DD/YYYY''),''Open'',''John ';
...
wwv_flow_imp.g_varchar2_table(18) := 'ng'',to_date(''01/02/2016'',''MM/DD/YYYY''),to_date(''01/02/2016'',''MM/DD/YYYY''),''Open'',''John Watson'',''200''';
...
wwv_flow_imp.g_varchar2_table(21) := 'ction'',to_date(''01/05/2016'',''MM/DD/YYYY''),to_date(''01/07/2016'',''MM/DD/YYYY''),''Open'',''James Cassidy'',';
...
wwv_flow_imp.g_varchar2_table(205) := 'E - TO_DATE(''01012016'',''MMDDYYYY''))'||wwv_flow.LF||
',   end_date = end_date + (SYSDATE - TO_DATE(''01012016'',''MMDDYYY';
...
'/'||wwv_flow.LF||
'show e';
wwv_flow_imp.g_varchar2_table(232) := 'rrors'||wwv_flow.LF||
'    '||wwv_flow.LF||
'begin'||wwv_flow.LF||
'EBA_DEMO_IR_DATA;'||wwv_flow.LF||
'commit;'||wwv_flow.LF||
'end;'||wwv_flow.LF||
'/'||wwv_flow.LF||
''||wwv_flow.LF||
