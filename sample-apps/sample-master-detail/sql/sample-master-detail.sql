...
,p_static_id=>'feedback-preference'
...
,p_static_id=>'report-and-marquee'
...
,p_static_id=>'stacked-with-sub-detail'
...
,p_attributes=>wwv_flow_t_plugin_attributes(wwv_flow_t_varchar2(
  'sql_query', wwv_flow_string.join(wwv_flow_t_varchar2(
    ...
    'where upper(username) = upper(:APP_USER)')))).to_clob
...
,p_static_id=>'edit-master-record'
,p_event_sequence=>10
...
,p_attributes=>wwv_flow_t_plugin_attributes(wwv_flow_t_varchar2(
  'js_code', 'apex.message.showPageSuccess(''Eba\u0020Demo\u0020Md\u0020Projects\u0020updated'');')).to_clob
);
wwv_flow_imp_page.create_page_da_action(
...
,p_action=>'NATIVE_JAVASCRIPT_CODE'
,p_attributes=>wwv_flow_t_plugin_attributes(wwv_flow_t_varchar2(
  'js_code', 'apex.message.showPageSuccess(''Eba Demo Md Milestones updated'');')).to_clob
);
wwv_flow_imp_page.create_page_da_action(
...
,p_name=>'Refresh on Dialog Close'
,p_static_id=>'refresh-on-dialog-close-2'
,p_event_sequence=>40
,p_triggering_element_type=>'REGION'
...
,p_action=>'NATIVE_JAVASCRIPT_CODE'
,p_attributes=>wwv_flow_t_plugin_attributes(wwv_flow_t_varchar2(
  'js_code', 'apex.message.showPageSuccess(''Eba Demo Md Tasks updated'');')).to_clob
);
wwv_flow_imp_page.create_page_da_action(
...
,p_name=>'Refresh on Dialog Close'
,p_static_id=>'refresh-on-dialog-close-3'
,p_event_sequence=>40
,p_triggering_element_type=>'REGION'
...
,p_action=>'NATIVE_JAVASCRIPT_CODE'
,p_attributes=>wwv_flow_t_plugin_attributes(wwv_flow_t_varchar2(
  'js_code', 'apex.message.showPageSuccess(''Eba Demo Md Comments updated'');')).to_clob
);
wwv_flow_imp_page.create_page_da_action(
...
,p_static_id=>'associated-records'
);
wwv_flow_imp_page.create_region_column_group(
...
,p_static_id=>'create-button-dialog-closed'
,p_event_sequence=>20
...
,p_static_id=>'completed-date-is-not-forward-dated'
...
,p_static_id=>'completed-date-is-not-null'
...
,p_static_id=>'show-completed-date'
,p_event_sequence=>20
,p_triggering_element_type=>'ITEM'
...
,p_static_id=>'fetch-row-from-eba-demo-md-projects'
...
,p_static_id=>'process-row-of-eba-demo-md-projects'
,p_attributes=>wwv_flow_t_plugin_attributes(wwv_flow_t_varchar2(
  'lock_row', 'Y',
...
,p_static_id=>'eba-demo-md-milestones-save-interactive-grid-data'
,p_attributes=>wwv_flow_t_plugin_attributes(wwv_flow_t_varchar2(
  'lock_row', 'Y',
  'prevent_lost_updates', 'Y',
...
,p_static_id=>'fetch-row-from-eba-demo-md-milestones'
...
,p_static_id=>'process-row-of-eba-demo-md-milestones'
,p_attributes=>wwv_flow_t_plugin_attributes(wwv_flow_t_varchar2(
  'lock_row', 'Y',
  'prevent_lost_updates', 'Y',
  'return_primary_keys_after_insert', 'N',
...
,p_attributes=>wwv_flow_t_plugin_attributes(wwv_flow_t_varchar2(
  ...
  'items_to_submit', 'P9_MILESTONE_ID',
  'sql_query', wwv_flow_string.join(wwv_flow_t_varchar2(
    'select due_date',
    'from eba_demo_md_milestones',
...
,p_static_id=>'fetch-row-from-eba-demo-md-tasks'
...
,p_static_id=>'process-row-of-eba-demo-md-tasks'
,p_attributes=>wwv_flow_t_plugin_attributes(wwv_flow_t_varchar2(
  'lock_row', 'Y',
  'prevent_lost_updates', 'Y',
  'return_primary_keys_after_insert', 'N',
...
,p_static_id=>'comments-region-dialog-closed'
,p_event_sequence=>50
,p_triggering_element_type=>'REGION'
...
,p_attributes=>wwv_flow_t_plugin_attributes(wwv_flow_t_varchar2(
  'items_to_submit', 'P11_PROJECT_ID',
  'language', 'PLSQL',
  'plsql_code', 'null;',
...
,p_static_id=>'refresh-reports-on-add'
,p_event_sequence=>60
,p_triggering_element_type=>'REGION'
...
,p_static_id=>'task-region-dialog-closed'
,p_event_sequence=>30
,p_triggering_element_type=>'REGION'
...
,p_static_id=>'fetch-row-from-eba-demo-md-comments'
...
,p_static_id=>'process-row-of-eba-demo-md-comments'
,p_attributes=>wwv_flow_t_plugin_attributes(wwv_flow_t_varchar2(
  'lock_row', 'Y',
  'prevent_lost_updates', 'Y',
  'return_primary_keys_after_insert', 'N',
...
,p_static_id=>'fetch-row-from-eba-demo-md-task-todos'
...
,p_static_id=>'process-row-of-eba-demo-md-task-todos'
,p_attributes=>wwv_flow_t_plugin_attributes(wwv_flow_t_varchar2(
  'lock_row', 'Y',
  'prevent_lost_updates', 'Y',
  'return_primary_keys_after_insert', 'N',
...
,p_static_id=>'close-dialog'
,p_attributes=>wwv_flow_t_plugin_attributes(wwv_flow_t_varchar2(
  'items_to_return', 'P16_ID,REQUEST',
  'show_success_messages', 'N')).to_clob
,p_error_display_location=>'INLINE_IN_NOTIFICATION'
...
wwv_flow_imp_page.create_ig_report_view(
 p_id=>wwv_flow_imp.id(172594000005)
...
,p_static_id=>'start-date-end-date'
,p_validation_sequence=>10
...
,p_static_id=>'edit-comment-dialog-closed'
,p_event_sequence=>10
,p_triggering_element_type=>'REGION'
...
,p_static_id=>'comments-save-interactive-grid-data'
,p_attributes=>wwv_flow_t_plugin_attributes(wwv_flow_t_varchar2(
  'lock_row', 'Y',
  'prevent_lost_updates', 'Y',
  'return_primary_keys_after_insert', 'Y',
...
,p_static_id=>'links-save-interactive-grid-data'
,p_attributes=>wwv_flow_t_plugin_attributes(wwv_flow_t_varchar2(
  'lock_row', 'Y',
  'prevent_lost_updates', 'Y',
  'return_primary_keys_after_insert', 'Y',
...
,p_static_id=>'milestones-save-interactive-grid-data'
,p_attributes=>wwv_flow_t_plugin_attributes(wwv_flow_t_varchar2(
  'lock_row', 'Y',
  'prevent_lost_updates', 'Y',
  'return_primary_keys_after_insert', 'Y',
...
,p_static_id=>'tasks-save-interactive-grid-data'
,p_attributes=>wwv_flow_t_plugin_attributes(wwv_flow_t_varchar2(
  'lock_row', 'Y',
  'prevent_lost_updates', 'Y',
  'return_primary_keys_after_insert', 'Y',
...
,p_static_id=>'todos-save-interactive-grid-data'
,p_attributes=>wwv_flow_t_plugin_attributes(wwv_flow_t_varchar2(
  'lock_row', 'Y',
  'prevent_lost_updates', 'Y',
  'return_primary_keys_after_insert', 'Y',
...
,p_static_id=>'close-dialog'
,p_attributes=>wwv_flow_t_plugin_attributes(wwv_flow_t_varchar2(
  'items_to_return', 'P18_ID,REQUEST',
  'show_success_messages', 'N')).to_clob
,p_error_display_location=>'INLINE_IN_NOTIFICATION'
,p_process_when=>'CREATE,SAVE,DELETE'
,p_process_when_type=>'REQUEST_IN_CONDITION'
...
,p_static_id=>'close-dialog'
,p_attributes=>wwv_flow_t_plugin_attributes(wwv_flow_t_varchar2(
  'items_to_return', 'P19_ID,REQUEST',
  'show_success_messages', 'N')).to_clob
,p_error_display_location=>'INLINE_IN_NOTIFICATION'
,p_process_when=>'CREATE,SAVE,DELETE'
,p_process_when_type=>'REQUEST_IN_CONDITION'
...
,p_static_id=>'application-id-is-null'
,p_validation_sequence=>20
...
,p_static_id=>'must-start-with-http'
...
,p_static_id=>'show-link-type-items'
,p_event_sequence=>20
,p_triggering_element_type=>'ITEM'
...
,p_static_id=>'fetch-row-from-eba-demo-md-task-links'
...
,p_static_id=>'process-row-of-eba-demo-md-task-links'
,p_attributes=>wwv_flow_t_plugin_attributes(wwv_flow_t_varchar2(
  'lock_row', 'Y',
  'prevent_lost_updates', 'Y',
  'return_primary_keys_after_insert', 'N',
...
wwv_flow_imp_page.create_ig_report_view(
 p_id=>wwv_flow_imp.id(48428000001)
...
,p_static_id=>'comment-region-dialog-closed'
,p_event_sequence=>20
,p_triggering_element_type=>'REGION'
...
,p_static_id=>'tasks-region-dialog-closed'
,p_event_sequence=>30
,p_triggering_element_type=>'REGION'
...
,p_static_id=>'initialize-form-two-page-master-detail-detail'
,p_attributes=>wwv_flow_t_plugin_attributes(wwv_flow_t_varchar2(
  'current_row_total_item', 'P49_ROWID_COUNT',
  'next_primary_key_items', 'P49_ROWID_NEXT',
  'previous_primary_key_items', 'P49_ROWID_PREV')).to_clob
