This application demonstrates JSON Relational Duality Views in Oracle APEX using purchase orders, customers, products, and line items. It shows how APEX can work directly with a JSON Relational Duality View source, including stacked and inbox-style order pages, declarative create and edit flows, current JSON Relational Duality View DDL, generated JSON schema examples, and sample data inserted through JSON document payloads.
