# Oracle APEX UX Pattern Catalog

The Oracle APEX UX Pattern Catalog is a portable reference application for APEX developers and AI coding agents. It pairs working implementations with metadata that explains the intended experience and reusable design rationale. Explore examples for dashboards, browse and search, item details, data entry, and master-detail layouts.
