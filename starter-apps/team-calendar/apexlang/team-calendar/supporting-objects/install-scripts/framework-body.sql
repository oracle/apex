CREATE OR REPLACE PACKAGE BODY "EBA_CA_FW" as
        ...
        if l_old_tags.count > 0 then --do inserts and deletes
            ...
            for i in 1..l_new_tags.count loop
                ...
                exception when no_data_found then
                    insert into eba_ca_tags (tag, content_id, content_type )
            ...
            for i in 1..l_old_tags.count loop
                ...
                exception when no_data_found then
                    delete from eba_ca_tags where content_id = p_content_id and tag = l_old_tags(i);
    ...
    begin
        -- Remove old errors
        delete from eba_ca_errors where err_time <= current_timestamp - 21;
        -- Log the error.
