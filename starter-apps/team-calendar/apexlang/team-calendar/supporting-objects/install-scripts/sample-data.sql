...
create or replace package body eba_ca_sample_data as
    ...
    begin
        ...
        when not matched then
            insert ( type_id, type_name, display_color, border_color, is_active_yn, internal_yn, color_pref_id )
            values ( src.type_id, src.type_name, src.display_color, src.border_color, src.is_active_yn, src.internal_yn, src.color_pref_id );
        ...
        when not matched then
            insert (event_id, event_name, type_id, event_date_time,
                ...
                location, link_name_1, link_url_1, series_id )
            values (src.event_id, src.event_name, src.type_id, src.event_date_time,
                ...
                src.location, src.link_name_1, src.link_url_1, src.series_id );
    end load;
