...
insert into eba_cust_feedback_types (id, feedback_type) values (1, 'General Comment');
insert into eba_cust_feedback_types (id, feedback_type) values (2, 'Enhancement Request');
